...
const WelcomeScreen = ({ onStart }) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative pixel-borders bg-white border-4 border-slate-200 overflow-hidden shadow-2xl p-6 sm:p-8 pt-8 sm:pt-10 flex flex-col min-h-[500px] sm:min-h-[600px]">
                {/* Subtle Grid Background */}
                <div className="absolute inset-0 pixel-grid-bg-light opacity-10 pointer-events-none" />

                <div className="relative z-10 text-center flex-1 flex flex-col items-center">
                    {/* Logo Section */}
                    ...
                    {/* Game Theme Accent */}
                    <motion.p 
                        className="font-pixel text-brand-orange text-[8px] sm:text-xs mb-8 sm:mb-10 tracking-[0.2em] uppercase font-bold"
                    ...
                    <div className="w-full space-y-4 sm:space-y-6 mb-8 sm:mb-12 text-left px-1 sm:px-2 flex-1 flex flex-col justify-center">
                        <div className="flex items-center gap-4 sm:gap-5 border-b border-slate-50 pb-3 sm:pb-4">
                    ...
                    <div className="w-full flex-shrink-0 pt-2 sm:pt-4">
                        <PixelButton
                            onClick={handleStart}
                        ...
                        <p className="mt-4 sm:mt-6 text-[8px] sm:text-[10px] text-slate-400 font-sans uppercase tracking-[0.1em] opacity-70">
